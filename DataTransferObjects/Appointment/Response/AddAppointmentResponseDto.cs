...
namespace Medical.DataTransferObjects.Appointment.Response
{
    public sealed class AddAppointmentResponseDto
    {
        ...
        //public IEnumerable<AddAppointmentScheduleRequestDto> AppointmentSchedule { get; set; }

        public IEnumerable<AppointmentScheduleResponseDto> AppointmentSchedule { get; set; }
    }
}
